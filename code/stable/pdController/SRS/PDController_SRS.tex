...
\\
$c$ & Damping coeffecient of the spring & --
\\
...
\\
$k$ & Stifness coeffecient of the spring & ${\text{s}}$
\\
...
\label{Sec:ReqsScope}
The scope of the requirements includes a PD Control Loop  with three subsystems namely a  PD Controller, a Summing Point, and a Power Plant. Only  the Proportional and Derivative controllers are used in this sofware;  the Integral controller is beyond the scope of this project. Additionally, this software is intended to aid with the manual  tuning of the PD Controller.
...
\item{Damping Coeffecient: Quantity that characterizes a second order system's oscillatory response.}
\item{Stifness Coeffecient: Quantity that characterizes a spring's stiffness.}
\end{itemize}
...
\begin{itemize}
\item[Power plant:\phantomsection\label{pwrPlant}]{The Power Plant and the Sensor are coupled as a single unit. (RefBy: \hyperref[stifnessCoeffSpring]{A: Spring Stifness Coffecient}, \hyperref[pwrPlantTxFnx]{A: Transfer Function}, \hyperref[massSpring]{A: Spring Mass}, and \hyperref[damingCoeffSpring]{A: Spring Damping Coffecient}.)}
...
\item[Transfer Function:\phantomsection\label{pwrPlantTxFnx}]{The combined Power Plant and Sensor ( from  \hyperref[pwrPlant]{A: Power plant}  ) are characterized by a Second Order mass-spring-damper  System. (RefBy: \hyperref[TM:tmSOSystem]{TM: tmSOSystem}.)}
...
\item[Spring Damping Coffecient:\phantomsection\label{damingCoeffSpring}]{The Damping Coeffecient of the spring in the mass-spring-damper system ( \hyperref[pwrPlant]{A: Power plant} ) is assumed to be 1. (RefBy: \hyperref[likeChgPP]{LC: DC Gain and Time Constant} and \hyperref[GD:gdPowerPlant]{GD: gdPowerPlant}.)}
\item[Spring Stifness Coffecient:\phantomsection\label{stifnessCoeffSpring}]{The Stifness Coeffecient  of the spring in the mass-spring-damper system ( \hyperref[pwrPlant]{A: Power plant} ) is assumed to be 20. (RefBy: \hyperref[likeChgPP]{LC: DC Gain and Time Constant} and \hyperref[GD:gdPowerPlant]{GD: gdPowerPlant}.)}
\end{itemize}
...
Description & \begin{symbDescription}
              ...
              \item{$s$ is the Complex frequency-domain parameter (Unitless)}
              \item{$c$ is the Damping coeffecient of the spring (Unitless)}
              \item{$k$ is the Stifness coeffecient of the spring (${\text{s}}$)}
              \end{symbDescription}
\\ \midrule \\
Notes & The  Transfer Function  of a  Second Order System (mass-spring-damper) is characterized by this equation ( from \hyperref[pwrPlantTxFnx]{A: Transfer Function} ).
...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & The  Transfer Function of the Second Order System (from \hyperref[TM:tmSOSystem]{TM: tmSOSystem} ) is reduced to this equation by substituting the mass (m) to 1 Kg (from \hyperref[massSpring]{A: Spring Mass} ), the Damping Coeffecient ( $c$ ) to 1 (from \hyperref[damingCoeffSpring]{A: Spring Damping Coffecient} ), and the Stifness Coeffecient ( $k$ ) to 20 (from \hyperref[stifnessCoeffSpring]{A: Spring Stifness Coffecient} The equation is converted to the frequency domain by applying the Laplace transform ( from \hyperref[TM:laplaceTransform]{TM: laplaceTransform} ). Additionally, there are no external disturbances to the power plant ( from  \hyperref[externalDistub]{A: External disturbance} ).
...
\begin{itemize}
\item[DC Gain and Time Constant:\phantomsection\label{likeChgPP}]{The mass ,  Damping Coeffecient  and the Stifness Coeffecient may be changed to be supplied by the user ( from  \hyperref[massSpring]{A: Spring Mass} \hyperref[damingCoeffSpring]{A: Spring Damping Coffecient} \hyperref[stifnessCoeffSpring]{A: Spring Stifness Coffecient} ).}
\end{itemize}
...
\toprule
\textbf{} & \textbf{\hyperref[pwrPlant]{A: Power plant}} & \textbf{\hyperref[decoupled]{A: Decoupled equation}} & \textbf{\hyperref[setPoint]{A: Set-Point}} & \textbf{\hyperref[externalDistub]{A: External disturbance}} & \textbf{\hyperref[initialValue]{A: Initial Value}} & \textbf{\hyperref[parallelEq]{A: Parallel Equation}} & \textbf{\hyperref[unfilteredDerivative]{A: Unfiltered Derivative}} & \textbf{\hyperref[pwrPlantTxFnx]{A: Transfer Function}} & \textbf{\hyperref[massSpring]{A: Spring Mass}} & \textbf{\hyperref[damingCoeffSpring]{A: Spring Damping Coffecient}} & \textbf{\hyperref[stifnessCoeffSpring]{A: Spring Stifness Coffecient}}
\\
\midrule
\endhead
...
\\
\hyperref[damingCoeffSpring]{A: Spring Damping Coffecient} & X &  &  &  &  &  &  &  &  &  & 
\\
\hyperref[stifnessCoeffSpring]{A: Spring Stifness Coffecient} & X &  &  &  &  &  &  &  &  &  & 
\\
\bottomrule
