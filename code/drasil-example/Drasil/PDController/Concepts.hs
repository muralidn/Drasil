...
sym_s, sym_f_S, sym_f_t, sym_negInf, sym_posInf, sym_invLaplace, sym_Kd, sym_Kp,
       ...
       sym_CT, sym_CS, sym_TStep, sym_TSim, sym_AbsTol, sym_RelTol,
       sym_dampingCoeff, sym_stifnessCoeff :: Symbol
...
sym_dampingCoeff = Variable "c"
sym_stifnessCoeff = Variable "k"
